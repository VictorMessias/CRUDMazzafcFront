<template>
<div>
  <b-modal id="user-new" size="md" title="Criar usuário">
      ...
      <b-col cols="12">
          <b-form novalidate>
            ...
            <b-form-group label="Senha" label-for="password">
                <b-form-input id="password" placeholder="********" name="password" v-validate="'required|min:8'" v-model="password" type="password"></b-form-input>
                <b-form-invalid-feedback :state="submit ? !errors.has('password') : null">
                    Por favor, insira a senha, mínimo 8 caracteres.
                </b-form-invalid-feedback>
            </b-form-group>
